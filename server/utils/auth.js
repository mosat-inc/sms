        ...
        try {
            ...
            if (isEmail) {
                ...
                query = `SELECT u.id, u.username, u.email, u.password, u.temp_password, u.must_change_password, 
                         u.role, u.position, u.first_name, u.last_name, u.is_active, u.school_id, s.school_code, u.can_student_admission
    ...
    static async register(userData) {
        ...
        `, [
            ...
            const [newUser] = await connection.execute(
                'SELECT id, username, email, role, position, first_name, last_name, can_student_admission FROM users WHERE id = ?',
                [result.insertId]
            );
